    ...
    public sealed class SqlHelper
    {
        ...
        public static string GetConnectionString()
        {
            if (string.IsNullOrEmpty(_connectionString))
            {
                ...
                _connectionString = "Password=@cc3ss124;Persist Security Info=True;User ID=RSGAccess;Initial Catalog=ReservationServicesIntl;Data Source=54.208.246.191;";// config.Get("Data:RSINewConnectionString:ConnectionString");
            }
